...
# from baselines.Net_woDSSC import Net
...
def run(dataset,  all_datasets, start_epoch,num_domain, seed):
    ...
    parser.add_argument('--domain_num', type=float, default=num_domain,
                        help='the domain_num')
    ...
    parser.add_argument('--model_name', type=str, default=r'stymix batch=64 1e-2 ch-9_'+ str(seed),
    ...
    # parser.add_argument('--data_dir', default=r'E:\WDK_workshop\SRGRD\data\ch-3\data_withdomain_31',type=str)
...
if __name__ == '__main__':
    ...
    start_epoch = 71
    # 1024, 2048,3090,4587,5964,  6782, 7431, 8761, 9014
    seeds =[1024]
