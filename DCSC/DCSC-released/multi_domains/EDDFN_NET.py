...
from multi_domains.EDDFN import EDDFNModel
from utils import *
from metrics import *
...
class Net(object):
    def __init__(self, args, device):
        ...
        self.net = EDDFNModel(self.c_in, [self.c_hid], self.num_domain, self.dropout).to(self.device)
    ...
    def train_batch(self, epoch, nonrumor_loader, rumor_loader):
        ...
        for iter, (Nonrumors, Rumors) in enumerate(iterloader):
            ...
            preds, rec_feature, bert_feature,domain_pred = self.net(x, D)
