...
from multi_domains.EANN import CNN_Fusion
from utils import *
from metrics import *
...
class Net(object):
    def __init__(self, args, device):
        ...
        self.net = CNN_Fusion(self.domain_num, self.filter_num,self.c_in, self.c_hid, self.dropout).to(self.device)
        # self.net = Transformer_Fusion(self.domain_num, self.filter_num,self.c_in, self.c_hid, self.dropout).to(self.device)
